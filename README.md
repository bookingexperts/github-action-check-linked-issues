...
| `allow-only-external-issues`                  | No | `false`              | A boolean value indicating whether the action should only consider linked issues in external repositories. Implies `loose_matching: true`|
| `required-external-repo`                  | No | `''`              | For external issues, require this repo. |
